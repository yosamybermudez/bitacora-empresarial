...
use App\Entity\RecursosHumanosTrabajador;
...
class TrabajadorRepository extends ServiceEntityRepository
{
    ...
    {
        parent::__construct($registry, RecursosHumanosTrabajador::class);
    }

    private function updateData(RecursosHumanosTrabajador $entity, Usuario $usuario){
        try{
    ...
    public function add(RecursosHumanosTrabajador $entity, Usuario $usuario, bool $flush = false): void
    {
    ...
    public function remove(RecursosHumanosTrabajador $entity, bool $flush = false): void
    {
